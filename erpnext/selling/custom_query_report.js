...
erpnext.selling.CustomQueryReport = erpnext.selling.SellingController.extend({
  search:function(doc){
    me = this;
    return frappe.call({
    ...
    function filter(item) {
      for (var columnId in columnFilters) {
        if (columnId !== undefined && columnFilters[columnId] !== "") {
          ...
          // console.log([item[c.field],columnFilters[columnId],c])
  ...
  get_columns:function(doc){
    ...
    if (doc.item_groups){
      columns = [
       ...
       {id: "4", name: "Previously Ordered", field: "4",width:60, sortable: true},
       {id: "5", name: "Price List", field: "5",width:100, sortable: true},
       {id: "6", name: "Batch", field: "6",width:80, sortable: true},
       {id: "7", name: "Rate", field: "7",width:100, sortable: true},
       {id: "8", name: "Actual Qty", field: "8",width:100, sortable: true}
      ]
    }
    else {
      columns = [
